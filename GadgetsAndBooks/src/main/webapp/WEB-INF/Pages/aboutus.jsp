...
<html>
	...
	<body>
		<div class="container-fluid">
			<h3><b>Books:</b></h3>
			<h5><p>Here we are having different types of books.</p></h5>
			<h4><p>Story Books:</p></h4>
			<h5><p>Here we have different type of story books like children books, historic books, etc;</p></h5>
			<table align="center">
			<tr>
			<td>
			<img src="resources/images/100.png">
			</td>
			<td>
			<img src="resources/images/101.png">
			</td>
			</tr>
			</table>
